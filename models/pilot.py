...
class Pilot(Base):
    ...
    pilot_code = Column(String(32), unique=True, nullable=False, index=True)
    ...
    sessions = relationship("AssessmentSession", back_populates="pilot", cascade="all, delete-orphan")
